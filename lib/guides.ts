...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Mark complete only after the work is done", paragraphs: ["After performing the agreed service, mark the booking complete. Secure customer payment must already be recorded. The customer then has 48 hours to confirm completion or report a problem before the provider payout releases automatically."], checklist: ["Confirm secure payment first", "Perform the accepted scope", "Record approved changes", "Mark the correct booking complete", "Keep job evidence until payment is settled"] },
    ],
  },
  {
