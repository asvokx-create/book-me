...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages = ["", "/services", "/requests", "/pricing", "/providers/join", "/partners", "/locations", "/guides", "/promise", "/support", "/disputes", "/terms", "/privacy", "/provider-agreement", "/partner-agreement", "/ai-transparency", "/cookies", "/content-removal", "/accessibility"];
