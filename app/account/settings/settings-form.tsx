...
const emptySettings: Settings = { name: "", email: "", imageUrl: "", phone: "", city: "", state: "WA", radius: 10, bookingNotifications: true, messageNotifications: true, isProvider: false };
