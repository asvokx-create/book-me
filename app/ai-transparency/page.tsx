...
const sections = [
  ...
  ["Technology and attribution", <><p>The Safety Bot is a BookMe-operated automated rules system. It does not generate messages, make booking decisions, determine prices, or rank providers, and it does not send private chats or booking text to a generative-AI provider for moderation.</p><p className="mt-3">BookMe AI is a separate, optional help assistant for eligible paid provider accounts. When a user submits a question, BookMe sends that question and the recent assistant conversation to OpenAI’s API to generate an answer. BookMe instructs the assistant not to request sensitive information, and requests are sent with API response storage disabled. BookMe AI can make mistakes and cannot change bookings or accounts.</p><p className="mt-3">BookMe AI is powered by OpenAI. BookMe’s transparency and risk-documentation approach is informed by the voluntary <Link href="https://www.nist.gov/itl/ai-risk-management-framework" target="_blank" rel="noreferrer" className="font-bold underline">NIST AI Risk Management Framework</Link>.</p></>],
