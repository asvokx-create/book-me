...
const protections = [
  ...
  ["Stripe-powered payments", "Payments are handled by Stripe. Providers do not receive your full card information, and payment records stay connected to your booking."],
  ...
  return <main className="min-h-screen bg-[#f8f7f3] text-[#183126]">
    <header className="border-b border-[#183126]/10 bg-white/90 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-4 sm:px-6">
        <Link href="/" className="flex items-center gap-2.5 text-xl font-bold"><BrandLockup /></Link>
        <AccountNav />
      </div>
    </header>
