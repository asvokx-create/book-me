    ...
    <main className="min-h-screen bg-[#f8f7f3] text-[#183126]">
      ...
      <div className="mx-auto max-w-6xl px-6 py-8 sm:py-12">
        ...
        <div className="mt-7 grid gap-10 lg:grid-cols-[1.25fr_.75fr]">
          <div>
            <div className={`relative h-72 overflow-hidden rounded-[2.5rem] bg-gradient-to-br ${visual.gradient} sm:h-[420px]`}><div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_25%,rgba(255,255,255,.4),transparent_28%)]" /><div className="absolute bottom-[-40%] left-[18%] h-[90%] w-[80%] rounded-[50%] border-[36px] border-white/20" /><span className="absolute left-6 top-6 rounded-full bg-white/90 px-4 py-2 text-xs font-bold backdrop-blur">New listing</span><span className="absolute bottom-8 right-10 text-8xl opacity-80 sm:text-9xl">{visual.art}</span></div>
            <div className="py-8">
