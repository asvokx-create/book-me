...
export default async function OperationsPage() {
  ...
  return <main className="min-h-screen overflow-x-clip bg-[#f4f4ef] px-4 py-7 text-[#183126] sm:px-8 sm:py-8"><div className="mx-auto min-w-0 max-w-5xl">
    <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center"><div><p className="text-xs font-bold uppercase tracking-[.14em] text-[#718078]">Admin operations</p><h1 className="mt-2 text-3xl font-bold">Reliability center</h1></div><Link href="/admin" className="flex min-h-11 items-center rounded-full bg-[#183126] px-5 py-3 text-sm font-bold text-white">← Admin console</Link></div>
