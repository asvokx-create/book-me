...
export const metadata: Metadata = { title: "Log in | BubsBookings" };
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f8f7f3] px-5 py-8 text-[#183126]">
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-4rem)] max-w-6xl flex-col">
        ...
        <div className="flex flex-1 items-center justify-center py-10"><AuthForm mode="login" redirectTo={redirectTo} /></div>
      </div>
    </main>
  );
}
