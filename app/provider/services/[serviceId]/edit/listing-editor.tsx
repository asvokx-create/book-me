      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-6 rounded-[2rem] border border-[#183126]/10 bg-white p-6 shadow-[0_18px_50px_rgba(24,49,38,.08)] sm:p-9">
          ...
          {listing && <form onSubmit={save} className="mt-8 space-y-5">
            ...
            <label className="block"><span className="mb-2 block text-sm font-bold">Service area</span><input value={listing.location} onChange={(event) => change("location", event.target.value)} placeholder="City, State" className={inputClass} /><span className="mt-2 block text-xs text-[#849189]">{listing.multipleLocationsAllowed ? "Pro allows a different location for each listing." : "This location applies to all of your listings. Pro unlocks multiple locations."}</span></label>
