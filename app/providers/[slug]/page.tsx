...
export async function generateMetadata({ params }: PageProps<"/providers/[slug]">): Promise<Metadata> {
  ...
  return provider ? { title: `${provider.businessName} | BubsBookings`, description: provider.bio } : {};
}
