...
export default function AdminSupportQueue() {
  ...
  return <main className="min-h-screen bg-[#f4f4ef] text-[#183126]">
    <header className="border-b border-[#183126]/10 bg-white"><div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-5 py-4"><Link href="/admin" className="flex items-center gap-2 font-bold"><BrandLockup /><span className="hidden sm:inline">Admin</span></Link><Link href="/admin" className="rounded-full px-4 py-2 text-sm font-bold hover:bg-[#eee25a]">← Admin overview</Link></div></header>
