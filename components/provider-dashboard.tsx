...
type ProviderService = { id: string; companyId: string; companySlug: string; businessName: string; slug: string; title: string; category: string; price: number; durationMinutes: number; imageUrls: string[] };
