...
type StripeStatus = {
  ...
  connect: { started: boolean; chargesEnabled: boolean; payoutsEnabled: boolean; state: "not_started" | "in_review" | "action_needed" | "ready"; requirements: string[]; disabledReason: string | null };
};
