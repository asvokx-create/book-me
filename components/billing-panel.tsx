...
export default function BillingPanel({ plan }: { plan: ProviderPlan }) {
  ...
  return <div>
    <div><p className="text-sm font-semibold text-[#687a70]">Company subscription</p><h1 className="mt-1 text-3xl font-bold tracking-[-.04em] sm:text-4xl">Billing & payouts</h1><p className="mt-2 text-sm text-[#687a70]">Manage your provider plan, customer payments, and Stripe payouts.</p></div>
