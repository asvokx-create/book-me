...
export default function AffiliateLinkBuilder({ code }: { code: string }) {
  ...
  return <section className="rounded-[1.75rem] border border-[#183126]/10 bg-white p-5 sm:p-6">
    <h2 className="text-xl font-bold">Referral link builder</h2><p className="mt-1 text-sm text-[#687970]">Create links only to approved BubsBookings pages. Every visit uses the same secure attribution system.</p>
